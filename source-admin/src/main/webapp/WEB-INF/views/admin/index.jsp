	...
	<div id="wrapper">
					...
					<div class="dropdown profile-element">
						<span><img alt="image" class="img-circle"
							...
							class="clear"> <span class="block m-t-xs"><strong
									class="font-bold">${user.account}</strong></span> <span
						...
						<ul class="dropdown-menu animated fadeInRight m-t-xs">
							...
							<li class="divider"></li>
							<li><a href="/account/logout">安全退出</a></li>
						</ul>
					</div>
				...
				<i class="fa fa-home"></i>
				  ...
				  <span class="fa arrow"></span>
					...
					<ul class="nav nav-second-level">
						<li>
							<a class="J_menuItem" href="${ctx}/train/index">火车票</a>
						</li>
						<li>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row content-tabs">
				...
				<a href="${ctx}/account/logout" class="roll-nav roll-right J_tabExit"><i
			...
			<div class="row J_mainContent" id="content-main">
				<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
					src="${ctx}/admin/content" frameborder="0"
					data-id="index_v1" seamless></iframe>
			</div>
			
			
			<div class="footer">
				<div class="pull-right">
					&copy; 2017-2025 <a href="http://www.source.net/" target="_blank">source</a>
				</div>
			</div>
		</div>
		<!--右侧部分结束-->
