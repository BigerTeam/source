...
UserInfoDlg.addSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Feng.ctxPath + '/system/user/add', function (data) {
    	if(data.code==200){
    		Feng.success("添加成功!");
...
UserInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(Feng.ctxPath + "/system/user/edit", function (data) {
...
UserInfoDlg.chPwd = function () {
    var ajax = new $ax(Feng.ctxPath + "/system/user/changepw", function (data) {
    	if(data.code==200){
    		  Feng.success("修改成功!");
    	}else{
            Feng.error("修改失败!!" + data.message + "!");
...
$(function () {
    ...
    var ztree = new $ZTree("treeDemo", "/system/dept/tree");
